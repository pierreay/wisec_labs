...
class number_station_tx_usrp(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Number Station TX -- USRP", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Number Station TX -- USRP")
        ...
        self.settings = Qt.QSettings("GNU Radio", "number_station_tx_usrp")
...
def main(top_block_cls=number_station_tx_usrp, options=None):
